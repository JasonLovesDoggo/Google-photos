...
ALBUM_ID: Final[str] = "AFmVu-sHlfu-jY4R2Kv0wXSQeI_xguLOKgnnUBHVlfgR3J_ceIhtoj3F0Pj-sFGs1inAQNnmKUAL" # google photos album that you want to download from, get via album_manager.list()
...
async def create_src_file(photos):
    ...
    for photo in photos:
        ...
        src.append({'src': img['image']['url'], 'width': img['image']['width'], 'height': img['image']['height'], 'category': 'dog'})
